...
interface BookingsApi {
    @Operation(
        ...
        tags = ["booking [optional]", "TO"]
    )
    @ApiResponses(
        value = [ApiResponse(
            responseCode = "200",
            description = "The bookings matching the query",
            content = Content(mediaType = "application/json", array = ArraySchema(schema = Schema(implementation = Booking::class)))
        ), ApiResponse(
            responseCode = "400",
    ...
    @RequestMapping(value = ["/bookings"], produces = ["application/json"], method = [RequestMethod.GET])
    fun bookingsGet(
        @Parameter(
    ...
    @RequestMapping(value = ["/bookings/{id}"], produces = ["application/json"], method = [RequestMethod.GET])
    fun bookingsIdGet(
        @Parameter(
            `in` = ParameterIn.HEADER,
            description = "A list of the languages/localizations the user would like to see the results in. For user privacy and ease of use on the TO side, this list should be kept as short as possible, ideally just one language tag from the list in operator/information",
    ...
    @RequestMapping(value = ["/bookings/{id}/notifications"], produces = ["application/json"], method = [RequestMethod.GET])
    ...
    @RequestMapping(value = ["/bookings/{id}"], produces = ["application/json"], consumes = ["application/json"], method = [RequestMethod.PUT])
    fun bookingsIdPut(
        @Parameter(
            `in` = ParameterIn.HEADER,
            description = "A list of the languages/localizations the user would like to see the results in. For user privacy and ease of use on the TO side, this list should be kept as short as possible, ideally just one language tag from the list in operator/information",
    ...
    @ApiResponses(
        value = [ApiResponse(responseCode = "204", description = "Request was successful, no content to return."), ApiResponse(
            ...
            responseCode = "404",
            description = "The requested resources does not exist or the requester is not authorized to see it or know it exists."
        ), ApiResponse(responseCode = "410", description = "The requested resource is no longer available. This is permanent."), ApiResponse(
            responseCode = "200",
            description = "Unexpected error",
            content = Content(mediaType = "application/json", schema = Schema(implementation = Error::class))
        )]
    )
    @RequestMapping(value = ["/bookings/{id}/subscription"], produces = ["application/json"], method = [RequestMethod.DELETE])
    ...
    @RequestMapping(value = ["/bookings/{id}/subscription"], produces = ["application/json"], method = [RequestMethod.POST])
    ...
    @RequestMapping(value = ["/bookings"], produces = ["application/json"], consumes = ["application/json"], method = [RequestMethod.POST])
    fun bookingsPost(
        @Parameter(
            `in` = ParameterIn.HEADER,
            description = "A list of the languages/localizations the user would like to see the results in. For user privacy and ease of use on the TO side, this list should be kept as short as possible, ideally just one language tag from the list in operator/information",
