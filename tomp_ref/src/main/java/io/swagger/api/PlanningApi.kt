...
interface PlanningApi {
    ...
    @ApiResponses(
        value = [ApiResponse(
            ...
            content = Content(mediaType = "application/json", schema = Schema(implementation = Planning::class))
        ), ApiResponse(
            responseCode = "400",
    ...
    @RequestMapping(value = ["/planning/inquiries"], produces = ["application/json"], consumes = ["application/json"], method = [RequestMethod.POST])
    ...
    @RequestMapping(value = ["/planning/offers"], produces = ["application/json"], consumes = ["application/json"], method = [RequestMethod.POST])
