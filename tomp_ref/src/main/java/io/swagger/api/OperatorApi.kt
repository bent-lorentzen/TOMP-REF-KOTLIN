...
interface OperatorApi {
    @Operation(
        ...
        tags = ["operator information", "TO"]
    )
    @ApiResponses(
        value = [ApiResponse(
            responseCode = "200",
            description = "returns currently active system alerts",
            content = Content(mediaType = "application/json", array = ArraySchema(schema = Schema(implementation = SystemAlert::class)))
        ), ApiResponse(
            responseCode = "400",
    ...
    @ApiResponses(
        value = [ApiResponse(
            ...
            content = Content(mediaType = "application/json", array = ArraySchema(schema = Schema(implementation = AssetType::class)))
        ), ApiResponse(
            responseCode = "400",
            description = "Bad request. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for further explanation of error code.",
            content = Content(mediaType = "application/json", schema = Schema(implementation = Error::class))
    ...
    @ApiResponses(
        value = [ApiResponse(
            ...
            content = Content(mediaType = "application/json", schema = Schema(implementation = SystemInformation::class))
        ), ApiResponse(
            responseCode = "400",
            description = "Bad request. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for further explanation of error code.",
            content = Content(mediaType = "application/json", schema = Schema(implementation = Error::class))
    ...
    @Operation(
        ...
        tags = ["operator information", "TO", "MP"]
    )
    @ApiResponses(
        value = [ApiResponse(
            responseCode = "200",
            description = "successful operation",
            content = Content(mediaType = "application/json", array = ArraySchema(schema = Schema(implementation = EndpointImplementation::class)))
        )]
    )
    ...
    @ApiResponses(
        value = [ApiResponse(
            responseCode = "200",
            description = "successful operation",
            content = Content(mediaType = "application/json", array = ArraySchema(schema = Schema(implementation = SystemCalendar::class)))
        ), ApiResponse(
            responseCode = "400",
            description = "Bad request. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for further explanation of error code.",
            content = Content(mediaType = "application/json", schema = Schema(implementation = Error::class))
    ...
    @RequestMapping(value = ["/operator/operating-calendar"], produces = ["application/json"], method = [RequestMethod.GET])
    ...
    @ApiResponses(
        value = [ApiResponse(
            responseCode = "200",
            description = "successful operation",
            content = Content(mediaType = "application/json", array = ArraySchema(schema = Schema(implementation = SystemHours::class)))
        ), ApiResponse(
            responseCode = "400",
            description = "Bad request. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for further explanation of error code.",
            content = Content(mediaType = "application/json", schema = Schema(implementation = Error::class))
    ...
    @RequestMapping(value = ["/operator/ping"], produces = ["application/json"], method = [RequestMethod.GET])
    fun operatorPingGet(
        @Parameter(
            `in` = ParameterIn.HEADER,
            description = "A list of the languages/localizations the user would like to see the results in. For user privacy and ease of use on the TO side, this list should be kept as short as possible, ideally just one language tag from the list in operator/information",
    ...
    @ApiResponses(
        value = [ApiResponse(
            ...
            content = Content(mediaType = "application/json", array = ArraySchema(schema = Schema(implementation = SystemPricingPlan::class)))
        ), ApiResponse(
            responseCode = "400",
            description = "Bad request. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for further explanation of error code.",
            content = Content(mediaType = "application/json", schema = Schema(implementation = Error::class))
    ...
    @ApiResponses(
        value = [ApiResponse(
            responseCode = "200",
            description = "successful operation",
            content = Content(mediaType = "application/json", array = ArraySchema(schema = Schema(implementation = SystemRegion::class)))
        ), ApiResponse(
            responseCode = "400",
            description = "Bad request. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for further explanation of error code.",
            content = Content(mediaType = "application/json", schema = Schema(implementation = Error::class))
    ...
    @ApiResponses(
        value = [ApiResponse(
            responseCode = "200",
            description = "successful operation",
            content = Content(mediaType = "application/json", array = ArraySchema(schema = Schema(implementation = StationInformation::class)))
        ), ApiResponse(
            responseCode = "400",
            description = "Bad request. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for further explanation of error code.",
            content = Content(mediaType = "application/json", schema = Schema(implementation = Error::class))
