...
@RestController
class PlanningApiController @Autowired constructor(private val objectMapper: ObjectMapper, private val request: HttpServletRequest) : PlanningApi {
    ...
    companion object {
        private val log = LoggerFactory.getLogger(PlanningApiController::class.java)
    }
}
