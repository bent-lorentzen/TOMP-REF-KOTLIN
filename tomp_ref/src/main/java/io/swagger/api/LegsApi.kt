...
interface LegsApi {
    @Operation(
        ...
        tags = ["trip execution", "TO"]
    )
    @ApiResponses(
        value = [ApiResponse(
            responseCode = "200",
            description = "operation successful",
            content = Content(mediaType = "application/json", schema = Schema(implementation = Leg::class))
        ), ApiResponse(responseCode = "204", description = "Request was successful, no content to return."), ApiResponse(
            responseCode = "400",
    ...
    @RequestMapping(value = ["/legs/{id}/ancillaries/{category}/{number}"], produces = ["application/json"], method = [RequestMethod.DELETE])
    ...
    @RequestMapping(value = ["/legs/{id}/ancillaries/{category}/{number}"], produces = ["application/json"], method = [RequestMethod.POST])
    ...
    @ApiResponses(
        value = [ApiResponse(
            ...
            content = Content(mediaType = "application/json", array = ArraySchema(schema = Schema(implementation = Asset::class)))
        ), ApiResponse(
            responseCode = "400",
            description = "Bad request. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for further explanation of error code.",
            content = Content(mediaType = "application/json", schema = Schema(implementation = Error::class))
    ...
    @RequestMapping(value = ["/legs/{id}/available-assets"], produces = ["application/json"], method = [RequestMethod.GET])
    ...
    @RequestMapping(value = ["/legs/{id}/events"], produces = ["application/json"], consumes = ["application/json"], method = [RequestMethod.POST])
    ...
    @ApiResponses(
        value = [ApiResponse(
            responseCode = "200",
            description = "operation successful",
            content = Content(mediaType = "application/json", schema = Schema(implementation = LegProgress::class))
        ), ApiResponse(
            responseCode = "401",
            description = "Although the HTTP standard specifies \"unauthorized\", semantically this response means \"unauthenticated\". That is, the client must authenticate itself to get the requested response.",
            content = Content(mediaType = "application/json", schema = Schema(implementation = Error::class))
    ...
    @ApiResponses(
        value = [ApiResponse(responseCode = "204", description = "Request was successful, no content to return."), ApiResponse(
            responseCode = "400",
            description = "Bad request. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for further explanation of error code.",
            content = Content(mediaType = "application/json", schema = Schema(implementation = Error::class))
        ), ApiResponse(
    ...
    @RequestMapping(value = ["/legs/{id}/progress"], produces = ["application/json"], consumes = ["application/json"], method = [RequestMethod.POST])
    ...
    @RequestMapping(value = ["/legs/{id}"], produces = ["application/json"], consumes = ["application/json"], method = [RequestMethod.PUT])
    fun legsIdPut(
        @Parameter(
            `in` = ParameterIn.HEADER,
            description = "A list of the languages/localizations the user would like to see the results in. For user privacy and ease of use on the TO side, this list should be kept as short as possible, ideally just one language tag from the list in operator/information",
